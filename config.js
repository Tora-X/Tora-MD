...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || "mongodb+srv://sapumalpku_db_user:YOUR_PASSWORD_HERE@cluster0.fck7ezm.mongodb.net/?appName=Cluster0",
    SESSION_ID: "tora_session",
