...
module.exports = {
    ...
    MONGODB_URI: process.env.MONGODB_URI || "mongodb+srv://sapumalpku_db_user:xizAfPobMqToOSI4@cluster0.fck7ezm.mongodb.net/tora_db?retryWrites=true&w=majority&appName=Cluster0"
